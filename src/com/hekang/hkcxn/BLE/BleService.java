...
/**
 * Created by ACHAO on 2016/3/11 0009.
 */
public class BleService extends Service implements Constants {
    ...
    public boolean onUnbind(Intent intent) {
        close();
        instance = null;
        MyLogger.jLog().e("BleService is onUnbind");
...
//            mBluetoothAdapter.getBluetoothLeScanner().stopScan(mLeScanCallback);
    ...
    public boolean connect(final String address) {
        ...
        if (mBluetoothGatt != null && mBluetoothDeviceAddress != null
            ...
            if (mBluetoothGatt.connect()) {
                ...
                MyLogger.jLog().e("true");
                return true;
            } else {
                MyLogger.jLog().e("false");
                return false;
            }
        }
        MyLogger.jLog().e("跳出判断");
        ...
        mConnState = STATE_CONNECTING;
        MyLogger.jLog().e("mConnState:" + mConnState);
        return true;
    }
    ...
    public void setCharacteristicNotification(String serviceUUID, String characteristicUUID,
                                              boolean enabled) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.e(TAG, "jiangchao---------------------->BluetoothAdapter not initialized");
            return;
        }
        BluetoothGattService service =
                mBluetoothGatt.getService(UUID.fromString(serviceUUID));
